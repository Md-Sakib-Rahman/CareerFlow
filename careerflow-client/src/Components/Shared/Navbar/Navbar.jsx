  ...
  return (
    <nav className="w-full bg-base-100/80 shadow-sm fixed top-0 left-0 z-50 backdrop-blur-xl border-b border-base-300 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        ...
        /* 2. Professional Underline Logic */
      ...
      `}
          ...
          <div className="hidden md:flex items-center gap-5">
            <Link to={"/login"} className="btn btn-outline btn-sm font-semibold text-primary">
              Login
            </Link>
            <Link to={"/register"} className="btn btn-primary btn-sm px-6 shadow-lg">
              Sign Up Free
            </Link>
            <div className="divider divider-horizontal mx-0"></div>
            <ThemeController />
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col px-6 py-8 space-y-6">
              ...
              >
                {["Features", "Analytics", "Pricing"].map((item) => (
                  <a
                    ...
                    className="text-lg font-semibold text-base-content/80 hover:text-primary transition-colors"
                  >
                    {item}
                  </a>
                ))}
              ...
              <motion.div
                variants={itemVariants}
                className="pt-4 border-t border-base-300 space-y-4"
              >
              ...
              <motion.div
                variants={itemVariants}
                className="text-center text-xs text-base-content/40"
              >
