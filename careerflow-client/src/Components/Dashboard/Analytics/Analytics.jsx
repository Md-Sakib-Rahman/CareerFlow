...
import { useSelector } from 'react-redux'; // ⚠️ NEW: To check user plan
import { useNavigate } from 'react-router'; // ⚠️ NEW: For the upgrade button
import { 
  BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, 
  PieChart, Pie, Cell, LineChart, Line, Legend 
} from 'recharts';
import { Target, CheckCircle, XCircle, Briefcase, BarChart3, PieChart as PieIcon, Ghost, Clock, TrendingUp, Download, Crown } from 'lucide-react'; // ⚠️ Added Crown
...
const Analytics = () => {
  ...
  // 1. ⚠️ Pull user state to check their plan
  ...
  // ==========================================
  // ⚠️ RENDER ROUTING (Paywall -> Loading -> Content)
  // ==========================================

  // STATE 1: PAYWALL (Starter Users)
  if (isStarter) {
    return (
  ...
  // STATE 2: LOADING (Premium Users waiting for API)
  ...
  // STATE 3: FULL CONTENT (Premium Users loaded)
